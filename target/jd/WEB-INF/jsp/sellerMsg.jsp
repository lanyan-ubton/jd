        ...
        <div class="page" id="app">
                    ...
                    <div class="nav-list">
                        <ul>
                            <li class="nav-tab a_active waves-effect">
                                <a href="${pageContext.request.contextPath}/view/sellerMeg" class="li-a active" target="iframe">
                            ...
                            <li class="nav-tab nav-ul">
                                ...
                                <div class="nav-box">
                                    <a href="${pageContext.request.contextPath}/seller/myGoods" class="li-a-a" target="iframe">商品列表</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="nav-right" ref="navRight">
                ...
                <div class="content-page" ref="cPage">
                    <iframe name="iframe" width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath}/view/sellerMeg"></iframe>
                </div>
            </div>
        </div>
