    ...
    <body>
        ...
        <div class="dowebok" id="dowebok">
            ...
            <div class="form-container sign-up">
               <form:form modelAttribute="seller" action="${pageContext.request.contextPath}/seller/save" method="post" class="register">
               		<h1>注册</h1>
               		<form:input path="name" id="username" name="username" placeholder="请输入用户名" />
               		<form:password path="pwd" id="pwd" name="password" placeholder="请输入密码"/>
            ...
            <div class="form-container sign-in">
                <form:form modelAttribute="seller" action="${pageContext.request.contextPath}/seller/login" method="post" class="sign">
                	<h1>登录</h1>
